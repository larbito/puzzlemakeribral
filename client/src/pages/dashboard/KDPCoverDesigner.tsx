...
const KDPCoverDesigner: React.FC = () => {
  ...
  const renderStep = () => {
    switch(state.activeStep) {
          ...
          <div className="space-y-6">
            <div className="flex justify-between">
              <div className="space-y-4 w-1/2 pr-6">
                <h2 className="text-xl font-semibold text-gray-800">Book Settings</h2>
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Minimum 24 pages, maximum 900 pages</p>
                  </div>
              ...
              <div className="w-1/2 border rounded-lg p-4 bg-gray-50">
                <h3 className="text-sm font-medium text-gray-700 mb-4">Live Dimension Preview</h3>
                
                <div className="aspect-[1.4] relative border border-gray-300 bg-white mb-4 overflow-hidden">
                  {/* Preview rendering area */}
                  <div className="absolute inset-0 flex items-center justify-center">
                    {/* Dynamic preview based on settings */}
                    <div className="relative h-3/4 flex">
                      {/* Back cover */}
                      <div className="h-full aspect-[2/3] bg-gray-100 border border-gray-300 relative">
                        ...
                        {state.bookSettings.includeISBN && (
                          <div className="absolute bottom-3 right-3 w-16 h-8 bg-gray-300 rounded-sm flex items-center justify-center text-[8px] text-gray-600">
                            ISBN
                          </div>
                        )}
                      </div>
                      ...
                      {/* Spine */}
                      <div 
                        className="h-full bg-blue-100 border-t border-b border-gray-300 flex items-center justify-center"
                        style={{ 
                          width: `${Math.max(10, state.bookSettings.dimensions.spineWidth * 40)}px`
                        }}
                      >
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -rotate-90 whitespace-nowrap text-[8px] text-gray-600">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{state.bookSettings.bookSize.replace('x', ' × "')}"</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Page Count:</span>
                    <span className="font-medium">{state.bookSettings.pageCount} pages</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Spine Width:</span>
                    <span className="font-medium">{state.bookSettings.dimensions.spineWidth.toFixed(3)}"</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Total Cover Size:</span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{state.bookSettings.includeBleed ? '0.125" (included)' : 'None'}</span>
                  </div>
                  <div className="flex justify-between">
      ...
      case 'frontCover':
        return (
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-gray-800">Front Cover Design</h2>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  <div className="flex flex-col items-center justify-center space-y-2">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-gray-700">Drag and drop file or click to upload</p>
      ...
      case 'backCover':
        return (
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-gray-800">Back Cover Design</h2>
            <p className="text-gray-500 text-sm mb-6">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-2 mt-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[1, 2, 3, 4].map((idx) => (
                      <div 
                        key={idx}
                        className="aspect-square border border-dashed border-gray-300 rounded-md flex items-center justify-center p-2"
                      >
                        <div className="text-center">
                          <Upload className="h-6 w-6 text-gray-400 mx-auto" />
                          <span className="text-xs text-gray-500">Image {idx}</span>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="space-y-4">
                ...
                >
                  {state.backCoverImage ? (
                    <div className="relative w-full h-full">
                      ...
                      {/* ISBN Placeholder */}
                      {state.bookSettings.includeISBN && (
                        <div className="absolute bottom-4 right-4 w-20 h-10 bg-white/80 rounded-sm flex items-center justify-center text-xs text-gray-800 border border-gray-300">
                          ISBN Barcode
                        </div>
                      )}
                    </div>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
                  <h4 className="text-sm font-medium text-blue-700 mb-2">Back Cover Tips</h4>
      ...
      case 'spine':
        return (
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-gray-800">Spine Design</h2>
            <p className="text-gray-500 text-sm mb-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2 mt-4">
                    ...
                    {['#3B82F6', '#10B981', '#F59E0B', '#EF4444', '#8B5CF6', '#000000'].map((color) => (
                      <div
                        ...
                        className={`w-full aspect-square rounded-md cursor-pointer transition-all ${
                          state.spineColor === color ? 'ring-2 ring-blue-500 ring-offset-2' : ''
                        }`}
                  ...
                  <div className="mt-2 flex items-center space-x-2">
                    ...
                    />
                    <span className="text-xs text-gray-500">{state.spineColor}</span>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6 p-4 bg-amber-50 rounded-lg border border-amber-100">
                  <h4 className="text-sm font-medium text-amber-700 mb-2">Spine Design Guidelines</h4>
      ...
      case 'preview':
        return (
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-gray-800">Full Cover Preview</h2>
            <p className="text-gray-500 text-sm mb-6">
            ...
            <div className="space-y-4">
              ...
              {/* Full Cover Preview */}
              <div className="flex justify-center items-center bg-gray-100 rounded-lg p-6 min-h-[500px]">
                {state.fullCoverImage ? (
                  <div className="relative shadow-xl">
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                      {/* Spine guides */}
                      <div className="absolute top-0 bottom-0 border-l-2 border-r-2 border-blue-500 border-dashed"
                        style={{
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                ...
                <div className="bg-white p-4 rounded-lg border shadow-sm">
                  ...
                  <div className="mt-2 h-20 bg-gray-100 rounded flex items-center justify-center overflow-hidden">
                    <div 
              ...
              <div className="bg-gray-50 p-4 rounded-lg border mt-4">
                ...
                <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span>{state.bookSettings.dimensions.totalWidth.toFixed(2)} × {state.bookSettings.dimensions.totalHeight.toFixed(2)} inches</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Resolution:</span>
                    <span>300 DPI</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-500">ISBN Barcode:</span>
      ...
      case 'export':
        return (
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-gray-800">Export Your Cover</h2>
            <p className="text-gray-500 text-sm mb-6">
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
                ...
                <div className="p-4">
                  <div className="aspect-[2/3] bg-gray-100 rounded-lg mb-4 flex items-center justify-center overflow-hidden">
                    {state.frontCoverImage ? (
                      <img 
                        src={state.frontCoverImage} 
                        alt="Front Cover" 
                  ...
                  <div className="space-y-2">
                    <div className="text-xs text-gray-500 flex justify-between">
                      <span>Size:</span>
                      <span>{state.bookSettings.dimensions.width}" × {state.bookSettings.dimensions.height}"</span>
                    </div>
              ...
              <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
                <div className="border-b px-4 py-3 bg-gray-50">
                  <h3 className="font-medium">Spine</h3>
                </div>
                <div className="p-4">
                  ...
                  <div className="space-y-2">
                    <div className="text-xs text-gray-500 flex justify-between">
                      <span>Width:</span>
                      <span>{state.bookSettings.dimensions.spineWidth.toFixed(3)}"</span>
                    </div>
            ...
            <div className="bg-white rounded-lg border shadow-sm overflow-hidden mt-6">
              <div className="border-b px-4 py-3 bg-gray-50">
                <h3 className="font-medium">Full Wrap Cover</h3>
              </div>
              <div className="p-4">
                <div className="aspect-[2/1] bg-gray-100 rounded-lg mb-4 flex items-center justify-center overflow-hidden">
                  {state.fullCoverImage ? (
                    <img 
                      src={state.fullCoverImage} 
                      alt="Full Cover Wrap" 
            ...
            <div className="bg-blue-50 rounded-lg border border-blue-100 p-4 mt-6">
              <h3 className="font-medium text-blue-800 mb-2">KDP Upload Instructions</h3>
              <div className="text-sm text-blue-700 space-y-2">
                ...
                <ul className="list-disc pl-6 text-blue-600 text-xs space-y-1 mt-1">
      ...
      default:
        return (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500 mb-4">This step is under development.</p>
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      <h1 className="text-3xl font-bold mb-2">KDP Cover Designer</h1>
