...
// Define which routes are coming soon (KDP formatter removed)
              ...
              return isComingSoon ? (
                ...
                >
                  ...
                  >
                    ...
                    <Badge 
                      variant="outline" 
                      className="ml-auto text-xs bg-amber-500/10 text-amber-500 border-amber-500/20 flex items-center gap-1"
                    >
