                ...
                element={
                  <DashboardLayout>
                    <Routes>
                      ...
                      {/* Coming Soon: Puzzle Generator */}
                      <Route path="puzzle-generator" element={<ComingSoon title="Puzzle Generator" />} />
                      {/* Coming Soon: Content Planner */}
                      <Route path="content" element={<ComingSoon title="Content Planner" />} />
                      {/* Coming Soon: KDP Calculator */}
                      <Route path="pricing" element={<ComingSoon title="KDP Calculator" />} />
                      ...
                      {/* Coming Soon: Merch Calculator */}
                      <Route path="merch-calculator" element={<ComingSoon title="Merch Calculator" />} />
